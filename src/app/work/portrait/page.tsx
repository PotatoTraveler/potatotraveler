// app/work/portrait/page.tsx
import Link from 'next/link';
import WorkGallery from '@/components/WorkGallery';
import { getPhotosByCategory } from '@/data/photos';

export const metadata = {
  title: 'Portrait Photography — Potato Traveler',
  description: 'Faces, expressions, and the quiet stories within.',
};
    ...
    <main className="min-h-screen pt-16">
      ...
      <header className="py-20 text-center">
        ...
        <p className="font-montserrat text-sm font-light text-gray-500 max-w-md mx-auto leading-relaxed">
          The subject — faces, expressions, and the quiet stories within.
        </p>
      </header>
